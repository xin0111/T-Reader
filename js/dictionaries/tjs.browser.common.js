...
function request(options)
{
    ...
    //google-baidu
    var textstr = options.query ? options.query.q : options.body ? options.body.query : '';
    ...
    return new Promise(function(resolve, reject) {
        ...
        xhr.onerror = function(e) {
            reject(getError("NETWORK_ERROR" /* NETWORK_ERROR */, /* e.message */ textstr));
        };
        xhr.send(body);
    });
}
...
function sign(text, seed)
{
    ...
    for (var e = t.split('.'), h = Number(e[0]) || 0, i = Number(e[1]) || 0, d = [], f = 0, g = 0; g < text.length; g++) {
        ...
        128 > m
            ...
            : (2048 > m
                      ? (d[f++] = (m >> 6) | 192)
                      : (55296 === (64512 & m) && g + 1 < text.length && 56320 === (64512 & text.charCodeAt(g + 1))
                                ? (m = 65536 + ((1023 & m) << 10) + (1023 & text.charCodeAt(++g)), d[f++] = (m >> 18) | 240, d[f++] = ((m >> 12) & 63) | 128)
                                : (d[f++] = (m >> 12) | 224),
                            d[f++] = ((m >> 6) & 63) | 128),
                  d[f++] = (63 & m) | 128);
    }
...
function translate(options)
{
    return tslib_1.__awaiter(this, void 0, void 0, function() {
        ...
        return tslib_1.__generator(this, function(_l) {
            ...
            case 3:
                return [ 4 /*yield*/, _f.apply(void 0, [ (_g.body = _j.apply(_h, _k.concat([ _l.sent() ])), _g.headers = headers$1, _g) ]) ];
            case 4:
                return [ 2 /*return*/, _d.apply(void 0, _e.concat([ _l.sent() ])) ];
            }
        });
    });
}
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function() {
        ...
        return tslib_1.__generator(this, function(_d) {
            ...
            case 1:
                ...
                _d.label = 2;
            case 2:
                return [ 2 /*return*/, getRoot(com) + "/translate_tts?ie=UTF-8&client=gtx&tl=" + from + "&q=" + encodeURIComponent(text) ];
            }
        });
    });
}
...
function translate$1(options)
{
    return tslib_1.__awaiter(this, void 0, void 0, function() {
        ...
        return tslib_1.__generator(this, function(_f) {
            ...
            case 3:
                return [ 2 /*return*/, _e.apply(void 0, [ _f.sent(),
                            {
                                from : from,
                                to : to,
                                com : com,
...
function detect$2(options)
{
    return tslib_1.__awaiter(this, void 0, void 0, function() {
        ...
        return tslib_1.__generator(this, function(_a) {
            switch (_a.label) {
            case 0:
                return [ 4 /*yield*/, webAPI(typeof options === 'string' ? options : options.text) ];
            case 1:
                result = _a.sent();
