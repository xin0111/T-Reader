  ...
  */
  function wrap() {
    ...
    /**
        ...
        @private
    */
    function textWrap(sentence,transfunc) {
      ...
      return {
        ...
        widths: widthMax,//measure(lineData, style),
        words: words
      };
  ...
  var TextBox = /*@__PURE__*/(function (BaseClass$$1) {
      ...
      var boxes = this._select.selectAll(".d3plus-textBox").data(this._data.reduce(function (arr, d, i) {
        ...
        */
        function checkSize() {
          ...
          wrapResults = wrapper(t,this$1._transData);
          ...
          if (lineData[i]) {
           ...
           {//next line
            ...
            arr.push({
              ...
              x: widthProg + padding.left ,
              y: heightPorg + yP + padding.top 
            });
            widthProg += wordWidth;   
          }
          //next word
          if(widthProg)
            widthProg +=10;// word space
        }
    ...
    */
    ...
    /**
        ...
        @chainable
    */
   TextBox.prototype.transData = function transData (_) {
    return arguments.length ? (this._transData = _, this) : this._transData;
  };
